/* @ts-self-types="./player_core.d.ts" */
...
export class PlayerCore {
    ...
    buffer_stats() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.playercore_buffer_stats(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    format() {
        const ret = wasm.playercore_format(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    load(data) {
        ...
        const ret = wasm.playercore_load(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    load_subtitles(data) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.playercore_load_subtitles(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    pause() {
        const ret = wasm.playercore_pause(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    play() {
        const ret = wasm.playercore_play(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    reset() {
        wasm.playercore_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    seek(timestamp_ms) {
        const ret = wasm.playercore_seek(this.__wbg_ptr, timestamp_ms);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    get state() {
        const ret = wasm.playercore_state(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) PlayerCore.prototype[Symbol.dispose] = PlayerCore.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('player_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
